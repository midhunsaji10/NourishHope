...
export default function AddOrphanage() {
    ...
    const validateForm = () => {
        ...
        // }
        if (!formData.orphanage_images) newErrors.orphanage_images = 'Image is required';
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            formDataToSend.append('orphanage_name', formData.orphanage_name);
